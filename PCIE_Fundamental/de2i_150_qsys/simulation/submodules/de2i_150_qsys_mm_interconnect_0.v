...
module de2i_150_qsys_mm_interconnect_0 (
	...
	wire  [148:0] rsp_mux_001_src_data;                                                      // rsp_mux_001:src_data -> sgdma_m_write_agent:rp_data
	wire          rsp_mux_001_src_ready;                                                     // sgdma_m_write_agent:rp_ready -> rsp_mux_001:src_ready
	wire    [6:0] rsp_mux_001_src_channel;                                                   // rsp_mux_001:src_channel -> sgdma_m_write_agent:rp_channel
	...
	wire          rsp_mux_002_src_valid;                                                     // rsp_mux_002:src_valid -> sgdma_descriptor_read_agent:rp_valid
	wire  [112:0] rsp_mux_002_src_data;                                                      // rsp_mux_002:src_data -> sgdma_descriptor_read_agent:rp_data
	wire          rsp_mux_002_src_ready;                                                     // sgdma_descriptor_read_agent:rp_ready -> rsp_mux_002:src_ready
	wire    [6:0] rsp_mux_002_src_channel;                                                   // rsp_mux_002:src_channel -> sgdma_descriptor_read_agent:rp_channel
	wire          rsp_mux_002_src_startofpacket;                                             // rsp_mux_002:src_startofpacket -> sgdma_descriptor_read_agent:rp_startofpacket
	wire          rsp_mux_002_src_endofpacket;                                               // rsp_mux_002:src_endofpacket -> sgdma_descriptor_read_agent:rp_endofpacket
	...
	wire          rsp_mux_003_src_valid;                                                     // rsp_mux_003:src_valid -> sgdma_descriptor_write_agent:rp_valid
	wire  [112:0] rsp_mux_003_src_data;                                                      // rsp_mux_003:src_data -> sgdma_descriptor_write_agent:rp_data
	wire          rsp_mux_003_src_ready;                                                     // sgdma_descriptor_write_agent:rp_ready -> rsp_mux_003:src_ready
	wire    [6:0] rsp_mux_003_src_channel;                                                   // rsp_mux_003:src_channel -> sgdma_descriptor_write_agent:rp_channel
	wire          rsp_mux_003_src_startofpacket;                                             // rsp_mux_003:src_startofpacket -> sgdma_descriptor_write_agent:rp_startofpacket
	wire          rsp_mux_003_src_endofpacket;                                               // rsp_mux_003:src_endofpacket -> sgdma_descriptor_write_agent:rp_endofpacket
	...
	wire  [148:0] sgdma_m_write_agent_cp_data;                                               // sgdma_m_write_agent:cp_data -> router_001:sink_data
	...
	wire  [148:0] router_001_src_data;                                                       // router_001:src_data -> cmd_demux_001:sink_data
	...
	wire          sgdma_descriptor_read_agent_cp_valid;                                      // sgdma_descriptor_read_agent:cp_valid -> router_002:sink_valid
	wire  [112:0] sgdma_descriptor_read_agent_cp_data;                                       // sgdma_descriptor_read_agent:cp_data -> router_002:sink_data
	wire          sgdma_descriptor_read_agent_cp_ready;                                      // router_002:sink_ready -> sgdma_descriptor_read_agent:cp_ready
	wire          sgdma_descriptor_read_agent_cp_startofpacket;                              // sgdma_descriptor_read_agent:cp_startofpacket -> router_002:sink_startofpacket
	wire          sgdma_descriptor_read_agent_cp_endofpacket;                                // sgdma_descriptor_read_agent:cp_endofpacket -> router_002:sink_endofpacket
	...
	wire          sgdma_descriptor_write_agent_cp_valid;                                     // sgdma_descriptor_write_agent:cp_valid -> router_003:sink_valid
	wire  [112:0] sgdma_descriptor_write_agent_cp_data;                                      // sgdma_descriptor_write_agent:cp_data -> router_003:sink_data
	wire          sgdma_descriptor_write_agent_cp_ready;                                     // router_003:sink_ready -> sgdma_descriptor_write_agent:cp_ready
	wire          sgdma_descriptor_write_agent_cp_startofpacket;                             // sgdma_descriptor_write_agent:cp_startofpacket -> router_003:sink_startofpacket
	wire          sgdma_descriptor_write_agent_cp_endofpacket;                               // sgdma_descriptor_write_agent:cp_endofpacket -> router_003:sink_endofpacket
	...
	wire          sgdma_m_read_agent_cp_valid;                                               // sgdma_m_read_agent:cp_valid -> router_004:sink_valid
	wire  [148:0] sgdma_m_read_agent_cp_data;                                                // sgdma_m_read_agent:cp_data -> router_004:sink_data
	wire          sgdma_m_read_agent_cp_ready;                                               // router_004:sink_ready -> sgdma_m_read_agent:cp_ready
	wire          sgdma_m_read_agent_cp_startofpacket;                                       // sgdma_m_read_agent:cp_startofpacket -> router_004:sink_startofpacket
	wire          sgdma_m_read_agent_cp_endofpacket;                                         // sgdma_m_read_agent:cp_endofpacket -> router_004:sink_endofpacket
	wire          fifo_memory_in_agent_rp_valid;                                             // fifo_memory_in_agent:rp_valid -> router_005:sink_valid
	wire  [148:0] fifo_memory_in_agent_rp_data;                                              // fifo_memory_in_agent:rp_data -> router_005:sink_data
	wire          fifo_memory_in_agent_rp_ready;                                             // router_005:sink_ready -> fifo_memory_in_agent:rp_ready
	wire          fifo_memory_in_agent_rp_startofpacket;                                     // fifo_memory_in_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire          fifo_memory_in_agent_rp_endofpacket;                                       // fifo_memory_in_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire          fifo_memory_in_csr_agent_rp_valid;                                         // fifo_memory_in_csr_agent:rp_valid -> router_006:sink_valid
	wire  [112:0] fifo_memory_in_csr_agent_rp_data;                                          // fifo_memory_in_csr_agent:rp_data -> router_006:sink_data
	wire          fifo_memory_in_csr_agent_rp_ready;                                         // router_006:sink_ready -> fifo_memory_in_csr_agent:rp_ready
	wire          fifo_memory_in_csr_agent_rp_startofpacket;                                 // fifo_memory_in_csr_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire          fifo_memory_in_csr_agent_rp_endofpacket;                                   // fifo_memory_in_csr_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire          fifo_memory_out_agent_rp_valid;                                            // fifo_memory_out_agent:rp_valid -> router_007:sink_valid
	wire  [148:0] fifo_memory_out_agent_rp_data;                                             // fifo_memory_out_agent:rp_data -> router_007:sink_data
	wire          fifo_memory_out_agent_rp_ready;                                            // router_007:sink_ready -> fifo_memory_out_agent:rp_ready
	wire          fifo_memory_out_agent_rp_startofpacket;                                    // fifo_memory_out_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire          fifo_memory_out_agent_rp_endofpacket;                                      // fifo_memory_out_agent:rp_endofpacket -> router_007:sink_endofpacket
	wire          router_007_src_valid;                                                      // router_007:src_valid -> rsp_demux_002:sink_valid
	wire  [148:0] router_007_src_data;                                                       // router_007:src_data -> rsp_demux_002:sink_data
	...
	wire  [148:0] onchip_memory_s1_agent_rp_data;                                            // onchip_memory_s1_agent:rp_data -> router_008:sink_data
	...
	wire  [148:0] router_008_src_data;                                                       // router_008:src_data -> rsp_demux_003:sink_data
	...
	wire  [112:0] led_s1_agent_rp_data;                                                      // led_s1_agent:rp_data -> router_009:sink_data
	...
	wire  [112:0] button_s1_agent_rp_data;                                                   // button_s1_agent:rp_data -> router_010:sink_data
	...
	wire  [112:0] router_010_src_data;                                                       // router_010:src_data -> rsp_demux_005:sink_data
	...
	wire          router_004_src_valid;                                                      // router_004:src_valid -> sgdma_m_read_limiter:cmd_sink_valid
	wire  [148:0] router_004_src_data;                                                       // router_004:src_data -> sgdma_m_read_limiter:cmd_sink_data
	wire          router_004_src_ready;                                                      // sgdma_m_read_limiter:cmd_sink_ready -> router_004:src_ready
	wire    [6:0] router_004_src_channel;                                                    // router_004:src_channel -> sgdma_m_read_limiter:cmd_sink_channel
	wire          router_004_src_startofpacket;                                              // router_004:src_startofpacket -> sgdma_m_read_limiter:cmd_sink_startofpacket
	wire          router_004_src_endofpacket;                                                // router_004:src_endofpacket -> sgdma_m_read_limiter:cmd_sink_endofpacket
	wire  [148:0] sgdma_m_read_limiter_cmd_src_data;                                         // sgdma_m_read_limiter:cmd_src_data -> cmd_demux_004:sink_data
	wire          sgdma_m_read_limiter_cmd_src_ready;                                        // cmd_demux_004:sink_ready -> sgdma_m_read_limiter:cmd_src_ready
	wire    [6:0] sgdma_m_read_limiter_cmd_src_channel;                                      // sgdma_m_read_limiter:cmd_src_channel -> cmd_demux_004:sink_channel
	wire          sgdma_m_read_limiter_cmd_src_startofpacket;                                // sgdma_m_read_limiter:cmd_src_startofpacket -> cmd_demux_004:sink_startofpacket
	wire          sgdma_m_read_limiter_cmd_src_endofpacket;                                  // sgdma_m_read_limiter:cmd_src_endofpacket -> cmd_demux_004:sink_endofpacket
	wire          rsp_mux_004_src_valid;                                                     // rsp_mux_004:src_valid -> sgdma_m_read_limiter:rsp_sink_valid
	wire  [148:0] rsp_mux_004_src_data;                                                      // rsp_mux_004:src_data -> sgdma_m_read_limiter:rsp_sink_data
	wire          rsp_mux_004_src_ready;                                                     // sgdma_m_read_limiter:rsp_sink_ready -> rsp_mux_004:src_ready
	wire    [6:0] rsp_mux_004_src_channel;                                                   // rsp_mux_004:src_channel -> sgdma_m_read_limiter:rsp_sink_channel
	wire          rsp_mux_004_src_startofpacket;                                             // rsp_mux_004:src_startofpacket -> sgdma_m_read_limiter:rsp_sink_startofpacket
	wire          rsp_mux_004_src_endofpacket;                                               // rsp_mux_004:src_endofpacket -> sgdma_m_read_limiter:rsp_sink_endofpacket
	...
	wire  [148:0] cmd_mux_src_data;                                                          // cmd_mux:src_data -> fifo_memory_in_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                                                         // fifo_memory_in_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire    [6:0] cmd_mux_src_channel;                                                       // cmd_mux:src_channel -> fifo_memory_in_burst_adapter:sink0_channel
	...
	wire          cmd_mux_001_src_valid;                                                     // cmd_mux_001:src_valid -> fifo_memory_in_csr_burst_adapter:sink0_valid
	wire  [112:0] cmd_mux_001_src_data;                                                      // cmd_mux_001:src_data -> fifo_memory_in_csr_burst_adapter:sink0_data
	wire          cmd_mux_001_src_ready;                                                     // fifo_memory_in_csr_burst_adapter:sink0_ready -> cmd_mux_001:src_ready
	wire    [6:0] cmd_mux_001_src_channel;                                                   // cmd_mux_001:src_channel -> fifo_memory_in_csr_burst_adapter:sink0_channel
	wire          cmd_mux_001_src_startofpacket;                                             // cmd_mux_001:src_startofpacket -> fifo_memory_in_csr_burst_adapter:sink0_startofpacket
	wire          cmd_mux_001_src_endofpacket;                                               // cmd_mux_001:src_endofpacket -> fifo_memory_in_csr_burst_adapter:sink0_endofpacket
	...
	wire          cmd_mux_002_src_valid;                                                     // cmd_mux_002:src_valid -> fifo_memory_out_burst_adapter:sink0_valid
	wire  [148:0] cmd_mux_002_src_data;                                                      // cmd_mux_002:src_data -> fifo_memory_out_burst_adapter:sink0_data
	wire          cmd_mux_002_src_ready;                                                     // fifo_memory_out_burst_adapter:sink0_ready -> cmd_mux_002:src_ready
	wire    [6:0] cmd_mux_002_src_channel;                                                   // cmd_mux_002:src_channel -> fifo_memory_out_burst_adapter:sink0_channel
	wire          cmd_mux_002_src_startofpacket;                                             // cmd_mux_002:src_startofpacket -> fifo_memory_out_burst_adapter:sink0_startofpacket
	wire          cmd_mux_002_src_endofpacket;                                               // cmd_mux_002:src_endofpacket -> fifo_memory_out_burst_adapter:sink0_endofpacket
	...
	wire          cmd_mux_003_src_valid;                                                     // cmd_mux_003:src_valid -> onchip_memory_s1_burst_adapter:sink0_valid
	wire  [148:0] cmd_mux_003_src_data;                                                      // cmd_mux_003:src_data -> onchip_memory_s1_burst_adapter:sink0_data
	wire          cmd_mux_003_src_ready;                                                     // onchip_memory_s1_burst_adapter:sink0_ready -> cmd_mux_003:src_ready
	wire    [6:0] cmd_mux_003_src_channel;                                                   // cmd_mux_003:src_channel -> onchip_memory_s1_burst_adapter:sink0_channel
	wire          cmd_mux_003_src_startofpacket;                                             // cmd_mux_003:src_startofpacket -> onchip_memory_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_003_src_endofpacket;                                               // cmd_mux_003:src_endofpacket -> onchip_memory_s1_burst_adapter:sink0_endofpacket
	...
	wire    [6:0] onchip_memory_s1_burst_adapter_source0_channel;                            // onchip_memory_s1_burst_adapter:source0_channel -> onchip_memory_s1_agent:cp_channel
	...
	wire  [112:0] cmd_mux_004_src_data;                                                      // cmd_mux_004:src_data -> led_s1_burst_adapter:sink0_data
	wire          cmd_mux_004_src_ready;                                                     // led_s1_burst_adapter:sink0_ready -> cmd_mux_004:src_ready
	wire    [6:0] cmd_mux_004_src_channel;                                                   // cmd_mux_004:src_channel -> led_s1_burst_adapter:sink0_channel
	...
	wire          cmd_mux_005_src_valid;                                                     // cmd_mux_005:src_valid -> button_s1_burst_adapter:sink0_valid
	wire  [112:0] cmd_mux_005_src_data;                                                      // cmd_mux_005:src_data -> button_s1_burst_adapter:sink0_data
	wire          cmd_mux_005_src_ready;                                                     // button_s1_burst_adapter:sink0_ready -> cmd_mux_005:src_ready
	wire    [6:0] cmd_mux_005_src_channel;                                                   // cmd_mux_005:src_channel -> button_s1_burst_adapter:sink0_channel
	wire          cmd_mux_005_src_startofpacket;                                             // cmd_mux_005:src_startofpacket -> button_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_005_src_endofpacket;                                               // cmd_mux_005:src_endofpacket -> button_s1_burst_adapter:sink0_endofpacket
	...
	wire  [148:0] cmd_demux_001_src1_data;                                                   // cmd_demux_001:src1_data -> cmd_mux_003:sink1_data
	...
	wire  [148:0] cmd_demux_004_src0_data;                                                   // cmd_demux_004:src0_data -> cmd_mux_002:sink1_data
	wire          cmd_demux_004_src0_ready;                                                  // cmd_mux_002:sink1_ready -> cmd_demux_004:src0_ready
	wire    [6:0] cmd_demux_004_src0_channel;                                                // cmd_demux_004:src0_channel -> cmd_mux_002:sink1_channel
	...
	wire  [148:0] cmd_demux_004_src1_data;                                                   // cmd_demux_004:src1_data -> cmd_mux_003:sink2_data
	...
	wire          cmd_demux_004_src2_valid;                                                  // cmd_demux_004:src2_valid -> cmd_mux_006:sink3_valid
	wire  [148:0] cmd_demux_004_src2_data;                                                   // cmd_demux_004:src2_data -> cmd_mux_006:sink3_data
	wire          cmd_demux_004_src2_ready;                                                  // cmd_mux_006:sink3_ready -> cmd_demux_004:src2_ready
	wire    [6:0] cmd_demux_004_src2_channel;                                                // cmd_demux_004:src2_channel -> cmd_mux_006:sink3_channel
	wire          cmd_demux_004_src2_startofpacket;                                          // cmd_demux_004:src2_startofpacket -> cmd_mux_006:sink3_startofpacket
	wire          cmd_demux_004_src2_endofpacket;                                            // cmd_demux_004:src2_endofpacket -> cmd_mux_006:sink3_endofpacket
	...
	wire  [148:0] rsp_demux_002_src1_data;                                                   // rsp_demux_002:src1_data -> rsp_mux_004:sink0_data
	wire          rsp_demux_002_src1_ready;                                                  // rsp_mux_004:sink0_ready -> rsp_demux_002:src1_ready
	wire    [6:0] rsp_demux_002_src1_channel;                                                // rsp_demux_002:src1_channel -> rsp_mux_004:sink0_channel
	...
	wire  [148:0] rsp_demux_003_src1_data;                                                   // rsp_demux_003:src1_data -> rsp_mux_001:sink1_data
	...
	wire  [148:0] rsp_demux_003_src2_data;                                                   // rsp_demux_003:src2_data -> rsp_mux_004:sink1_data
	...
	wire          rsp_demux_006_src3_valid;                                                  // rsp_demux_006:src3_valid -> rsp_mux_004:sink2_valid
	wire  [148:0] rsp_demux_006_src3_data;                                                   // rsp_demux_006:src3_data -> rsp_mux_004:sink2_data
	wire          rsp_demux_006_src3_ready;                                                  // rsp_mux_004:sink2_ready -> rsp_demux_006:src3_ready
	wire    [6:0] rsp_demux_006_src3_channel;                                                // rsp_demux_006:src3_channel -> rsp_mux_004:sink2_channel
	wire          rsp_demux_006_src3_startofpacket;                                          // rsp_demux_006:src3_startofpacket -> rsp_mux_004:sink2_startofpacket
	wire          rsp_demux_006_src3_endofpacket;                                            // rsp_demux_006:src3_endofpacket -> rsp_mux_004:sink2_endofpacket
	wire          cmd_demux_src1_valid;                                                      // cmd_demux:src1_valid -> pcie_ip_bar1_0_to_fifo_memory_in_csr_cmd_width_adapter:in_valid
	wire  [148:0] cmd_demux_src1_data;                                                       // cmd_demux:src1_data -> pcie_ip_bar1_0_to_fifo_memory_in_csr_cmd_width_adapter:in_data
	wire          cmd_demux_src1_ready;                                                      // pcie_ip_bar1_0_to_fifo_memory_in_csr_cmd_width_adapter:in_ready -> cmd_demux:src1_ready
	wire    [6:0] cmd_demux_src1_channel;                                                    // cmd_demux:src1_channel -> pcie_ip_bar1_0_to_fifo_memory_in_csr_cmd_width_adapter:in_channel
	wire          cmd_demux_src1_startofpacket;                                              // cmd_demux:src1_startofpacket -> pcie_ip_bar1_0_to_fifo_memory_in_csr_cmd_width_adapter:in_startofpacket
	wire          cmd_demux_src1_endofpacket;                                                // cmd_demux:src1_endofpacket -> pcie_ip_bar1_0_to_fifo_memory_in_csr_cmd_width_adapter:in_endofpacket
	wire          pcie_ip_bar1_0_to_fifo_memory_in_csr_cmd_width_adapter_src_valid;          // pcie_ip_bar1_0_to_fifo_memory_in_csr_cmd_width_adapter:out_valid -> cmd_mux_001:sink0_valid
	wire  [112:0] pcie_ip_bar1_0_to_fifo_memory_in_csr_cmd_width_adapter_src_data;           // pcie_ip_bar1_0_to_fifo_memory_in_csr_cmd_width_adapter:out_data -> cmd_mux_001:sink0_data
	wire          pcie_ip_bar1_0_to_fifo_memory_in_csr_cmd_width_adapter_src_ready;          // cmd_mux_001:sink0_ready -> pcie_ip_bar1_0_to_fifo_memory_in_csr_cmd_width_adapter:out_ready
	wire    [6:0] pcie_ip_bar1_0_to_fifo_memory_in_csr_cmd_width_adapter_src_channel;        // pcie_ip_bar1_0_to_fifo_memory_in_csr_cmd_width_adapter:out_channel -> cmd_mux_001:sink0_channel
	wire          pcie_ip_bar1_0_to_fifo_memory_in_csr_cmd_width_adapter_src_startofpacket;  // pcie_ip_bar1_0_to_fifo_memory_in_csr_cmd_width_adapter:out_startofpacket -> cmd_mux_001:sink0_startofpacket
	wire          pcie_ip_bar1_0_to_fifo_memory_in_csr_cmd_width_adapter_src_endofpacket;    // pcie_ip_bar1_0_to_fifo_memory_in_csr_cmd_width_adapter:out_endofpacket -> cmd_mux_001:sink0_endofpacket
	wire          cmd_demux_src4_valid;                                                      // cmd_demux:src4_valid -> pcie_ip_bar1_0_to_led_s1_cmd_width_adapter:in_valid
	wire  [148:0] cmd_demux_src4_data;                                                       // cmd_demux:src4_data -> pcie_ip_bar1_0_to_led_s1_cmd_width_adapter:in_data
	wire          cmd_demux_src4_ready;                                                      // pcie_ip_bar1_0_to_led_s1_cmd_width_adapter:in_ready -> cmd_demux:src4_ready
	wire    [6:0] cmd_demux_src4_channel;                                                    // cmd_demux:src4_channel -> pcie_ip_bar1_0_to_led_s1_cmd_width_adapter:in_channel
	wire          cmd_demux_src4_startofpacket;                                              // cmd_demux:src4_startofpacket -> pcie_ip_bar1_0_to_led_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_demux_src4_endofpacket;                                                // cmd_demux:src4_endofpacket -> pcie_ip_bar1_0_to_led_s1_cmd_width_adapter:in_endofpacket
	wire          pcie_ip_bar1_0_to_led_s1_cmd_width_adapter_src_valid;                      // pcie_ip_bar1_0_to_led_s1_cmd_width_adapter:out_valid -> cmd_mux_004:sink0_valid
	wire  [112:0] pcie_ip_bar1_0_to_led_s1_cmd_width_adapter_src_data;                       // pcie_ip_bar1_0_to_led_s1_cmd_width_adapter:out_data -> cmd_mux_004:sink0_data
	wire          pcie_ip_bar1_0_to_led_s1_cmd_width_adapter_src_ready;                      // cmd_mux_004:sink0_ready -> pcie_ip_bar1_0_to_led_s1_cmd_width_adapter:out_ready
	wire    [6:0] pcie_ip_bar1_0_to_led_s1_cmd_width_adapter_src_channel;                    // pcie_ip_bar1_0_to_led_s1_cmd_width_adapter:out_channel -> cmd_mux_004:sink0_channel
	wire          pcie_ip_bar1_0_to_led_s1_cmd_width_adapter_src_startofpacket;              // pcie_ip_bar1_0_to_led_s1_cmd_width_adapter:out_startofpacket -> cmd_mux_004:sink0_startofpacket
	wire          pcie_ip_bar1_0_to_led_s1_cmd_width_adapter_src_endofpacket;                // pcie_ip_bar1_0_to_led_s1_cmd_width_adapter:out_endofpacket -> cmd_mux_004:sink0_endofpacket
	wire          cmd_demux_src5_valid;                                                      // cmd_demux:src5_valid -> pcie_ip_bar1_0_to_button_s1_cmd_width_adapter:in_valid
	wire  [148:0] cmd_demux_src5_data;                                                       // cmd_demux:src5_data -> pcie_ip_bar1_0_to_button_s1_cmd_width_adapter:in_data
	wire          cmd_demux_src5_ready;                                                      // pcie_ip_bar1_0_to_button_s1_cmd_width_adapter:in_ready -> cmd_demux:src5_ready
	wire    [6:0] cmd_demux_src5_channel;                                                    // cmd_demux:src5_channel -> pcie_ip_bar1_0_to_button_s1_cmd_width_adapter:in_channel
	wire          cmd_demux_src5_startofpacket;                                              // cmd_demux:src5_startofpacket -> pcie_ip_bar1_0_to_button_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_demux_src5_endofpacket;                                                // cmd_demux:src5_endofpacket -> pcie_ip_bar1_0_to_button_s1_cmd_width_adapter:in_endofpacket
	wire          pcie_ip_bar1_0_to_button_s1_cmd_width_adapter_src_valid;                   // pcie_ip_bar1_0_to_button_s1_cmd_width_adapter:out_valid -> cmd_mux_005:sink0_valid
	wire  [112:0] pcie_ip_bar1_0_to_button_s1_cmd_width_adapter_src_data;                    // pcie_ip_bar1_0_to_button_s1_cmd_width_adapter:out_data -> cmd_mux_005:sink0_data
	wire          pcie_ip_bar1_0_to_button_s1_cmd_width_adapter_src_ready;                   // cmd_mux_005:sink0_ready -> pcie_ip_bar1_0_to_button_s1_cmd_width_adapter:out_ready
	wire    [6:0] pcie_ip_bar1_0_to_button_s1_cmd_width_adapter_src_channel;                 // pcie_ip_bar1_0_to_button_s1_cmd_width_adapter:out_channel -> cmd_mux_005:sink0_channel
	wire          pcie_ip_bar1_0_to_button_s1_cmd_width_adapter_src_startofpacket;           // pcie_ip_bar1_0_to_button_s1_cmd_width_adapter:out_startofpacket -> cmd_mux_005:sink0_startofpacket
	wire          pcie_ip_bar1_0_to_button_s1_cmd_width_adapter_src_endofpacket;             // pcie_ip_bar1_0_to_button_s1_cmd_width_adapter:out_endofpacket -> cmd_mux_005:sink0_endofpacket
	wire          cmd_demux_002_src0_valid;                                                  // cmd_demux_002:src0_valid -> sgdma_descriptor_read_to_pcie_ip_txs_cmd_width_adapter:in_valid
	wire  [112:0] cmd_demux_002_src0_data;                                                   // cmd_demux_002:src0_data -> sgdma_descriptor_read_to_pcie_ip_txs_cmd_width_adapter:in_data
	wire          cmd_demux_002_src0_ready;                                                  // sgdma_descriptor_read_to_pcie_ip_txs_cmd_width_adapter:in_ready -> cmd_demux_002:src0_ready
	wire    [6:0] cmd_demux_002_src0_channel;                                                // cmd_demux_002:src0_channel -> sgdma_descriptor_read_to_pcie_ip_txs_cmd_width_adapter:in_channel
	wire          cmd_demux_002_src0_startofpacket;                                          // cmd_demux_002:src0_startofpacket -> sgdma_descriptor_read_to_pcie_ip_txs_cmd_width_adapter:in_startofpacket
	wire          cmd_demux_002_src0_endofpacket;                                            // cmd_demux_002:src0_endofpacket -> sgdma_descriptor_read_to_pcie_ip_txs_cmd_width_adapter:in_endofpacket
	wire          sgdma_descriptor_read_to_pcie_ip_txs_cmd_width_adapter_src_valid;          // sgdma_descriptor_read_to_pcie_ip_txs_cmd_width_adapter:out_valid -> cmd_mux_006:sink1_valid
	wire  [148:0] sgdma_descriptor_read_to_pcie_ip_txs_cmd_width_adapter_src_data;           // sgdma_descriptor_read_to_pcie_ip_txs_cmd_width_adapter:out_data -> cmd_mux_006:sink1_data
	wire          sgdma_descriptor_read_to_pcie_ip_txs_cmd_width_adapter_src_ready;          // cmd_mux_006:sink1_ready -> sgdma_descriptor_read_to_pcie_ip_txs_cmd_width_adapter:out_ready
	wire    [6:0] sgdma_descriptor_read_to_pcie_ip_txs_cmd_width_adapter_src_channel;        // sgdma_descriptor_read_to_pcie_ip_txs_cmd_width_adapter:out_channel -> cmd_mux_006:sink1_channel
	wire          sgdma_descriptor_read_to_pcie_ip_txs_cmd_width_adapter_src_startofpacket;  // sgdma_descriptor_read_to_pcie_ip_txs_cmd_width_adapter:out_startofpacket -> cmd_mux_006:sink1_startofpacket
	wire          sgdma_descriptor_read_to_pcie_ip_txs_cmd_width_adapter_src_endofpacket;    // sgdma_descriptor_read_to_pcie_ip_txs_cmd_width_adapter:out_endofpacket -> cmd_mux_006:sink1_endofpacket
	wire          cmd_demux_003_src0_valid;                                                  // cmd_demux_003:src0_valid -> sgdma_descriptor_write_to_pcie_ip_txs_cmd_width_adapter:in_valid
	wire  [112:0] cmd_demux_003_src0_data;                                                   // cmd_demux_003:src0_data -> sgdma_descriptor_write_to_pcie_ip_txs_cmd_width_adapter:in_data
	wire          cmd_demux_003_src0_ready;                                                  // sgdma_descriptor_write_to_pcie_ip_txs_cmd_width_adapter:in_ready -> cmd_demux_003:src0_ready
	wire    [6:0] cmd_demux_003_src0_channel;                                                // cmd_demux_003:src0_channel -> sgdma_descriptor_write_to_pcie_ip_txs_cmd_width_adapter:in_channel
	wire          cmd_demux_003_src0_startofpacket;                                          // cmd_demux_003:src0_startofpacket -> sgdma_descriptor_write_to_pcie_ip_txs_cmd_width_adapter:in_startofpacket
	wire          cmd_demux_003_src0_endofpacket;                                            // cmd_demux_003:src0_endofpacket -> sgdma_descriptor_write_to_pcie_ip_txs_cmd_width_adapter:in_endofpacket
	wire          sgdma_descriptor_write_to_pcie_ip_txs_cmd_width_adapter_src_valid;         // sgdma_descriptor_write_to_pcie_ip_txs_cmd_width_adapter:out_valid -> cmd_mux_006:sink2_valid
	wire  [148:0] sgdma_descriptor_write_to_pcie_ip_txs_cmd_width_adapter_src_data;          // sgdma_descriptor_write_to_pcie_ip_txs_cmd_width_adapter:out_data -> cmd_mux_006:sink2_data
	wire          sgdma_descriptor_write_to_pcie_ip_txs_cmd_width_adapter_src_ready;         // cmd_mux_006:sink2_ready -> sgdma_descriptor_write_to_pcie_ip_txs_cmd_width_adapter:out_ready
	wire    [6:0] sgdma_descriptor_write_to_pcie_ip_txs_cmd_width_adapter_src_channel;       // sgdma_descriptor_write_to_pcie_ip_txs_cmd_width_adapter:out_channel -> cmd_mux_006:sink2_channel
	wire          sgdma_descriptor_write_to_pcie_ip_txs_cmd_width_adapter_src_startofpacket; // sgdma_descriptor_write_to_pcie_ip_txs_cmd_width_adapter:out_startofpacket -> cmd_mux_006:sink2_startofpacket
	wire          sgdma_descriptor_write_to_pcie_ip_txs_cmd_width_adapter_src_endofpacket;   // sgdma_descriptor_write_to_pcie_ip_txs_cmd_width_adapter:out_endofpacket -> cmd_mux_006:sink2_endofpacket
	wire          rsp_demux_001_src0_valid;                                                  // rsp_demux_001:src0_valid -> fifo_memory_in_csr_to_pcie_ip_bar1_0_rsp_width_adapter:in_valid
	wire  [112:0] rsp_demux_001_src0_data;                                                   // rsp_demux_001:src0_data -> fifo_memory_in_csr_to_pcie_ip_bar1_0_rsp_width_adapter:in_data
	wire          rsp_demux_001_src0_ready;                                                  // fifo_memory_in_csr_to_pcie_ip_bar1_0_rsp_width_adapter:in_ready -> rsp_demux_001:src0_ready
	wire    [6:0] rsp_demux_001_src0_channel;                                                // rsp_demux_001:src0_channel -> fifo_memory_in_csr_to_pcie_ip_bar1_0_rsp_width_adapter:in_channel
	wire          rsp_demux_001_src0_startofpacket;                                          // rsp_demux_001:src0_startofpacket -> fifo_memory_in_csr_to_pcie_ip_bar1_0_rsp_width_adapter:in_startofpacket
	wire          rsp_demux_001_src0_endofpacket;                                            // rsp_demux_001:src0_endofpacket -> fifo_memory_in_csr_to_pcie_ip_bar1_0_rsp_width_adapter:in_endofpacket
	wire          fifo_memory_in_csr_to_pcie_ip_bar1_0_rsp_width_adapter_src_valid;          // fifo_memory_in_csr_to_pcie_ip_bar1_0_rsp_width_adapter:out_valid -> rsp_mux:sink1_valid
	wire  [148:0] fifo_memory_in_csr_to_pcie_ip_bar1_0_rsp_width_adapter_src_data;           // fifo_memory_in_csr_to_pcie_ip_bar1_0_rsp_width_adapter:out_data -> rsp_mux:sink1_data
	wire          fifo_memory_in_csr_to_pcie_ip_bar1_0_rsp_width_adapter_src_ready;          // rsp_mux:sink1_ready -> fifo_memory_in_csr_to_pcie_ip_bar1_0_rsp_width_adapter:out_ready
	wire    [6:0] fifo_memory_in_csr_to_pcie_ip_bar1_0_rsp_width_adapter_src_channel;        // fifo_memory_in_csr_to_pcie_ip_bar1_0_rsp_width_adapter:out_channel -> rsp_mux:sink1_channel
	wire          fifo_memory_in_csr_to_pcie_ip_bar1_0_rsp_width_adapter_src_startofpacket;  // fifo_memory_in_csr_to_pcie_ip_bar1_0_rsp_width_adapter:out_startofpacket -> rsp_mux:sink1_startofpacket
	wire          fifo_memory_in_csr_to_pcie_ip_bar1_0_rsp_width_adapter_src_endofpacket;    // fifo_memory_in_csr_to_pcie_ip_bar1_0_rsp_width_adapter:out_endofpacket -> rsp_mux:sink1_endofpacket
	wire          rsp_demux_004_src0_valid;                                                  // rsp_demux_004:src0_valid -> led_s1_to_pcie_ip_bar1_0_rsp_width_adapter:in_valid
	wire  [112:0] rsp_demux_004_src0_data;                                                   // rsp_demux_004:src0_data -> led_s1_to_pcie_ip_bar1_0_rsp_width_adapter:in_data
	wire          rsp_demux_004_src0_ready;                                                  // led_s1_to_pcie_ip_bar1_0_rsp_width_adapter:in_ready -> rsp_demux_004:src0_ready
	wire    [6:0] rsp_demux_004_src0_channel;                                                // rsp_demux_004:src0_channel -> led_s1_to_pcie_ip_bar1_0_rsp_width_adapter:in_channel
	wire          rsp_demux_004_src0_startofpacket;                                          // rsp_demux_004:src0_startofpacket -> led_s1_to_pcie_ip_bar1_0_rsp_width_adapter:in_startofpacket
	wire          rsp_demux_004_src0_endofpacket;                                            // rsp_demux_004:src0_endofpacket -> led_s1_to_pcie_ip_bar1_0_rsp_width_adapter:in_endofpacket
	wire          led_s1_to_pcie_ip_bar1_0_rsp_width_adapter_src_valid;                      // led_s1_to_pcie_ip_bar1_0_rsp_width_adapter:out_valid -> rsp_mux:sink4_valid
	wire  [148:0] led_s1_to_pcie_ip_bar1_0_rsp_width_adapter_src_data;                       // led_s1_to_pcie_ip_bar1_0_rsp_width_adapter:out_data -> rsp_mux:sink4_data
	wire          led_s1_to_pcie_ip_bar1_0_rsp_width_adapter_src_ready;                      // rsp_mux:sink4_ready -> led_s1_to_pcie_ip_bar1_0_rsp_width_adapter:out_ready
	wire    [6:0] led_s1_to_pcie_ip_bar1_0_rsp_width_adapter_src_channel;                    // led_s1_to_pcie_ip_bar1_0_rsp_width_adapter:out_channel -> rsp_mux:sink4_channel
	wire          led_s1_to_pcie_ip_bar1_0_rsp_width_adapter_src_startofpacket;              // led_s1_to_pcie_ip_bar1_0_rsp_width_adapter:out_startofpacket -> rsp_mux:sink4_startofpacket
	wire          led_s1_to_pcie_ip_bar1_0_rsp_width_adapter_src_endofpacket;                // led_s1_to_pcie_ip_bar1_0_rsp_width_adapter:out_endofpacket -> rsp_mux:sink4_endofpacket
	wire          rsp_demux_005_src0_valid;                                                  // rsp_demux_005:src0_valid -> button_s1_to_pcie_ip_bar1_0_rsp_width_adapter:in_valid
	wire  [112:0] rsp_demux_005_src0_data;                                                   // rsp_demux_005:src0_data -> button_s1_to_pcie_ip_bar1_0_rsp_width_adapter:in_data
	wire          rsp_demux_005_src0_ready;                                                  // button_s1_to_pcie_ip_bar1_0_rsp_width_adapter:in_ready -> rsp_demux_005:src0_ready
	wire    [6:0] rsp_demux_005_src0_channel;                                                // rsp_demux_005:src0_channel -> button_s1_to_pcie_ip_bar1_0_rsp_width_adapter:in_channel
	wire          rsp_demux_005_src0_startofpacket;                                          // rsp_demux_005:src0_startofpacket -> button_s1_to_pcie_ip_bar1_0_rsp_width_adapter:in_startofpacket
	wire          rsp_demux_005_src0_endofpacket;                                            // rsp_demux_005:src0_endofpacket -> button_s1_to_pcie_ip_bar1_0_rsp_width_adapter:in_endofpacket
	wire          button_s1_to_pcie_ip_bar1_0_rsp_width_adapter_src_valid;                   // button_s1_to_pcie_ip_bar1_0_rsp_width_adapter:out_valid -> rsp_mux:sink5_valid
	wire  [148:0] button_s1_to_pcie_ip_bar1_0_rsp_width_adapter_src_data;                    // button_s1_to_pcie_ip_bar1_0_rsp_width_adapter:out_data -> rsp_mux:sink5_data
	wire          button_s1_to_pcie_ip_bar1_0_rsp_width_adapter_src_ready;                   // rsp_mux:sink5_ready -> button_s1_to_pcie_ip_bar1_0_rsp_width_adapter:out_ready
	wire    [6:0] button_s1_to_pcie_ip_bar1_0_rsp_width_adapter_src_channel;                 // button_s1_to_pcie_ip_bar1_0_rsp_width_adapter:out_channel -> rsp_mux:sink5_channel
	wire          button_s1_to_pcie_ip_bar1_0_rsp_width_adapter_src_startofpacket;           // button_s1_to_pcie_ip_bar1_0_rsp_width_adapter:out_startofpacket -> rsp_mux:sink5_startofpacket
	wire          button_s1_to_pcie_ip_bar1_0_rsp_width_adapter_src_endofpacket;             // button_s1_to_pcie_ip_bar1_0_rsp_width_adapter:out_endofpacket -> rsp_mux:sink5_endofpacket
	wire          rsp_demux_006_src1_valid;                                                  // rsp_demux_006:src1_valid -> pcie_ip_txs_to_sgdma_descriptor_read_rsp_width_adapter:in_valid
	wire  [148:0] rsp_demux_006_src1_data;                                                   // rsp_demux_006:src1_data -> pcie_ip_txs_to_sgdma_descriptor_read_rsp_width_adapter:in_data
	wire          rsp_demux_006_src1_ready;                                                  // pcie_ip_txs_to_sgdma_descriptor_read_rsp_width_adapter:in_ready -> rsp_demux_006:src1_ready
	wire    [6:0] rsp_demux_006_src1_channel;                                                // rsp_demux_006:src1_channel -> pcie_ip_txs_to_sgdma_descriptor_read_rsp_width_adapter:in_channel
	wire          rsp_demux_006_src1_startofpacket;                                          // rsp_demux_006:src1_startofpacket -> pcie_ip_txs_to_sgdma_descriptor_read_rsp_width_adapter:in_startofpacket
	wire          rsp_demux_006_src1_endofpacket;                                            // rsp_demux_006:src1_endofpacket -> pcie_ip_txs_to_sgdma_descriptor_read_rsp_width_adapter:in_endofpacket
	wire          pcie_ip_txs_to_sgdma_descriptor_read_rsp_width_adapter_src_valid;          // pcie_ip_txs_to_sgdma_descriptor_read_rsp_width_adapter:out_valid -> rsp_mux_002:sink0_valid
	wire  [112:0] pcie_ip_txs_to_sgdma_descriptor_read_rsp_width_adapter_src_data;           // pcie_ip_txs_to_sgdma_descriptor_read_rsp_width_adapter:out_data -> rsp_mux_002:sink0_data
	wire          pcie_ip_txs_to_sgdma_descriptor_read_rsp_width_adapter_src_ready;          // rsp_mux_002:sink0_ready -> pcie_ip_txs_to_sgdma_descriptor_read_rsp_width_adapter:out_ready
	wire    [6:0] pcie_ip_txs_to_sgdma_descriptor_read_rsp_width_adapter_src_channel;        // pcie_ip_txs_to_sgdma_descriptor_read_rsp_width_adapter:out_channel -> rsp_mux_002:sink0_channel
	wire          pcie_ip_txs_to_sgdma_descriptor_read_rsp_width_adapter_src_startofpacket;  // pcie_ip_txs_to_sgdma_descriptor_read_rsp_width_adapter:out_startofpacket -> rsp_mux_002:sink0_startofpacket
	wire          pcie_ip_txs_to_sgdma_descriptor_read_rsp_width_adapter_src_endofpacket;    // pcie_ip_txs_to_sgdma_descriptor_read_rsp_width_adapter:out_endofpacket -> rsp_mux_002:sink0_endofpacket
	wire          rsp_demux_006_src2_valid;                                                  // rsp_demux_006:src2_valid -> pcie_ip_txs_to_sgdma_descriptor_write_rsp_width_adapter:in_valid
	wire  [148:0] rsp_demux_006_src2_data;                                                   // rsp_demux_006:src2_data -> pcie_ip_txs_to_sgdma_descriptor_write_rsp_width_adapter:in_data
	wire          rsp_demux_006_src2_ready;                                                  // pcie_ip_txs_to_sgdma_descriptor_write_rsp_width_adapter:in_ready -> rsp_demux_006:src2_ready
	wire    [6:0] rsp_demux_006_src2_channel;                                                // rsp_demux_006:src2_channel -> pcie_ip_txs_to_sgdma_descriptor_write_rsp_width_adapter:in_channel
	wire          rsp_demux_006_src2_startofpacket;                                          // rsp_demux_006:src2_startofpacket -> pcie_ip_txs_to_sgdma_descriptor_write_rsp_width_adapter:in_startofpacket
	wire          rsp_demux_006_src2_endofpacket;                                            // rsp_demux_006:src2_endofpacket -> pcie_ip_txs_to_sgdma_descriptor_write_rsp_width_adapter:in_endofpacket
	wire          pcie_ip_txs_to_sgdma_descriptor_write_rsp_width_adapter_src_valid;         // pcie_ip_txs_to_sgdma_descriptor_write_rsp_width_adapter:out_valid -> rsp_mux_003:sink0_valid
	wire  [112:0] pcie_ip_txs_to_sgdma_descriptor_write_rsp_width_adapter_src_data;          // pcie_ip_txs_to_sgdma_descriptor_write_rsp_width_adapter:out_data -> rsp_mux_003:sink0_data
	wire          pcie_ip_txs_to_sgdma_descriptor_write_rsp_width_adapter_src_ready;         // rsp_mux_003:sink0_ready -> pcie_ip_txs_to_sgdma_descriptor_write_rsp_width_adapter:out_ready
	wire    [6:0] pcie_ip_txs_to_sgdma_descriptor_write_rsp_width_adapter_src_channel;       // pcie_ip_txs_to_sgdma_descriptor_write_rsp_width_adapter:out_channel -> rsp_mux_003:sink0_channel
	wire          pcie_ip_txs_to_sgdma_descriptor_write_rsp_width_adapter_src_startofpacket; // pcie_ip_txs_to_sgdma_descriptor_write_rsp_width_adapter:out_startofpacket -> rsp_mux_003:sink0_startofpacket
	wire          pcie_ip_txs_to_sgdma_descriptor_write_rsp_width_adapter_src_endofpacket;   // pcie_ip_txs_to_sgdma_descriptor_write_rsp_width_adapter:out_endofpacket -> rsp_mux_003:sink0_endofpacket
	wire    [6:0] pcie_ip_bar1_0_limiter_cmd_valid_data;                                     // pcie_ip_bar1_0_limiter:cmd_src_valid -> cmd_demux:sink_valid
	wire    [6:0] sgdma_m_read_limiter_cmd_valid_data;                                       // sgdma_m_read_limiter:cmd_src_valid -> cmd_demux_004:sink_valid
	wire          fifo_memory_in_agent_rdata_fifo_src_valid;                                 // fifo_memory_in_agent:rdata_fifo_src_valid -> avalon_st_adapter:in_0_valid
	wire   [65:0] fifo_memory_in_agent_rdata_fifo_src_data;                                  // fifo_memory_in_agent:rdata_fifo_src_data -> avalon_st_adapter:in_0_data
	...
	wire   [65:0] avalon_st_adapter_out_0_data;                                              // avalon_st_adapter:out_0_data -> fifo_memory_in_agent:rdata_fifo_sink_data
	...
	wire          fifo_memory_in_csr_agent_rdata_fifo_src_valid;                             // fifo_memory_in_csr_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire   [33:0] fifo_memory_in_csr_agent_rdata_fifo_src_data;                              // fifo_memory_in_csr_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire          fifo_memory_in_csr_agent_rdata_fifo_src_ready;                             // avalon_st_adapter_001:in_0_ready -> fifo_memory_in_csr_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_001_out_0_valid;                                         // avalon_st_adapter_001:out_0_valid -> fifo_memory_in_csr_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_001_out_0_data;                                          // avalon_st_adapter_001:out_0_data -> fifo_memory_in_csr_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_001_out_0_ready;                                         // fifo_memory_in_csr_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire    [0:0] avalon_st_adapter_001_out_0_error;                                         // avalon_st_adapter_001:out_0_error -> fifo_memory_in_csr_agent:rdata_fifo_sink_error
	wire          fifo_memory_out_agent_rdata_fifo_src_valid;                                // fifo_memory_out_agent:rdata_fifo_src_valid -> avalon_st_adapter_002:in_0_valid
	wire   [65:0] fifo_memory_out_agent_rdata_fifo_src_data;                                 // fifo_memory_out_agent:rdata_fifo_src_data -> avalon_st_adapter_002:in_0_data
	wire          fifo_memory_out_agent_rdata_fifo_src_ready;                                // avalon_st_adapter_002:in_0_ready -> fifo_memory_out_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_002_out_0_valid;                                         // avalon_st_adapter_002:out_0_valid -> fifo_memory_out_agent:rdata_fifo_sink_valid
	wire   [65:0] avalon_st_adapter_002_out_0_data;                                          // avalon_st_adapter_002:out_0_data -> fifo_memory_out_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_002_out_0_ready;                                         // fifo_memory_out_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire    [0:0] avalon_st_adapter_002_out_0_error;                                         // avalon_st_adapter_002:out_0_error -> fifo_memory_out_agent:rdata_fifo_sink_error
	...
	wire   [65:0] onchip_memory_s1_agent_rdata_fifo_src_data;                                // onchip_memory_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	...
	wire   [65:0] avalon_st_adapter_003_out_0_data;                                          // avalon_st_adapter_003:out_0_data -> onchip_memory_s1_agent:rdata_fifo_sink_data
	...
	wire          pcie_ip_txs_agent_rdata_fifo_src_valid;                                    // pcie_ip_txs_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire   [65:0] pcie_ip_txs_agent_rdata_fifo_src_data;                                     // pcie_ip_txs_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire          pcie_ip_txs_agent_rdata_fifo_src_ready;                                    // avalon_st_adapter_006:in_0_ready -> pcie_ip_txs_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_006_out_0_valid;                                         // avalon_st_adapter_006:out_0_valid -> pcie_ip_txs_agent:rdata_fifo_sink_valid
	wire   [65:0] avalon_st_adapter_006_out_0_data;                                          // avalon_st_adapter_006:out_0_data -> pcie_ip_txs_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_006_out_0_ready;                                         // pcie_ip_txs_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire    [0:0] avalon_st_adapter_006_out_0_error;                                         // avalon_st_adapter_006:out_0_error -> pcie_ip_txs_agent:rdata_fifo_sink_error
	...
	de2i_150_qsys_mm_interconnect_0_router_006 router_009 (
	...
	de2i_150_qsys_mm_interconnect_0_router_006 router_010 (
	...
	de2i_150_qsys_mm_interconnect_0_cmd_demux_002 cmd_demux_003 (
		.clk                (pcie_ip_pcie_core_clk_clk),               //       clk.clk
		.reset              (sgdma_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	de2i_150_qsys_mm_interconnect_0_cmd_mux_001 cmd_mux_004 (
		.clk                 (pcie_ip_pcie_core_clk_clk),                                    //       clk.clk
		.reset               (sgdma_reset_reset_bridge_in_reset_reset),                      // clk_reset.reset
	...
	de2i_150_qsys_mm_interconnect_0_cmd_mux_001 cmd_mux_005 (
		.clk                 (pcie_ip_pcie_core_clk_clk),                                       //       clk.clk
		.reset               (sgdma_reset_reset_bridge_in_reset_reset),                         // clk_reset.reset
	...
	de2i_150_qsys_mm_interconnect_0_cmd_mux_006 cmd_mux_006 (
		...
		.sink1_ready         (sgdma_descriptor_read_to_pcie_ip_txs_cmd_width_adapter_src_ready),          //     sink1.ready
		.sink1_valid         (sgdma_descriptor_read_to_pcie_ip_txs_cmd_width_adapter_src_valid),          //          .valid
		.sink1_channel       (sgdma_descriptor_read_to_pcie_ip_txs_cmd_width_adapter_src_channel),        //          .channel
		.sink1_data          (sgdma_descriptor_read_to_pcie_ip_txs_cmd_width_adapter_src_data),           //          .data
		.sink1_startofpacket (sgdma_descriptor_read_to_pcie_ip_txs_cmd_width_adapter_src_startofpacket),  //          .startofpacket
		.sink1_endofpacket   (sgdma_descriptor_read_to_pcie_ip_txs_cmd_width_adapter_src_endofpacket),    //          .endofpacket
		.sink2_ready         (sgdma_descriptor_write_to_pcie_ip_txs_cmd_width_adapter_src_ready),         //     sink2.ready
		.sink2_valid         (sgdma_descriptor_write_to_pcie_ip_txs_cmd_width_adapter_src_valid),         //          .valid
		.sink2_channel       (sgdma_descriptor_write_to_pcie_ip_txs_cmd_width_adapter_src_channel),       //          .channel
		.sink2_data          (sgdma_descriptor_write_to_pcie_ip_txs_cmd_width_adapter_src_data),          //          .data
		.sink2_startofpacket (sgdma_descriptor_write_to_pcie_ip_txs_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.sink2_endofpacket   (sgdma_descriptor_write_to_pcie_ip_txs_cmd_width_adapter_src_endofpacket),   //          .endofpacket
		.sink3_ready         (cmd_demux_004_src2_ready),                                                  //     sink3.ready
		.sink3_valid         (cmd_demux_004_src2_valid),                                                  //          .valid
		.sink3_channel       (cmd_demux_004_src2_channel),                                                //          .channel
		.sink3_data          (cmd_demux_004_src2_data),                                                   //          .data
		.sink3_startofpacket (cmd_demux_004_src2_startofpacket),                                          //          .startofpacket
		.sink3_endofpacket   (cmd_demux_004_src2_endofpacket)                                             //          .endofpacket
	);
	...
	de2i_150_qsys_mm_interconnect_0_cmd_demux_002 rsp_demux_001 (
		.clk                (pcie_ip_pcie_core_clk_clk),               //       clk.clk
		.reset              (sgdma_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	de2i_150_qsys_mm_interconnect_0_cmd_demux_001 rsp_demux_003 (
		.clk                (pcie_ip_pcie_core_clk_clk),               //       clk.clk
		.reset              (sgdma_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	de2i_150_qsys_mm_interconnect_0_cmd_demux_002 rsp_demux_004 (
		.clk                (pcie_ip_pcie_core_clk_clk),               //       clk.clk
		.reset              (sgdma_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	de2i_150_qsys_mm_interconnect_0_rsp_mux rsp_mux (
		...
		.sink1_ready         (fifo_memory_in_csr_to_pcie_ip_bar1_0_rsp_width_adapter_src_ready),         //     sink1.ready
		.sink1_valid         (fifo_memory_in_csr_to_pcie_ip_bar1_0_rsp_width_adapter_src_valid),         //          .valid
		.sink1_channel       (fifo_memory_in_csr_to_pcie_ip_bar1_0_rsp_width_adapter_src_channel),       //          .channel
		.sink1_data          (fifo_memory_in_csr_to_pcie_ip_bar1_0_rsp_width_adapter_src_data),          //          .data
		.sink1_startofpacket (fifo_memory_in_csr_to_pcie_ip_bar1_0_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.sink1_endofpacket   (fifo_memory_in_csr_to_pcie_ip_bar1_0_rsp_width_adapter_src_endofpacket),   //          .endofpacket
	...
	de2i_150_qsys_mm_interconnect_0_rsp_mux_001 rsp_mux_004 (
		.clk                 (pcie_ip_pcie_core_clk_clk),               //       clk.clk
		.reset               (sgdma_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	de2i_150_qsys_mm_interconnect_0_avalon_st_adapter_001 #(
		...
		.in_clk_0_clk   (pcie_ip_pcie_core_clk_clk),                     // in_clk_0.clk
		.in_rst_0_reset (sgdma_reset_reset_bridge_in_reset_reset),       // in_rst_0.reset
		.in_0_data      (fifo_memory_in_csr_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (fifo_memory_in_csr_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (fifo_memory_in_csr_agent_rdata_fifo_src_ready), //         .ready
	...
	de2i_150_qsys_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (pcie_ip_pcie_core_clk_clk),                  // in_clk_0.clk
		.in_rst_0_reset (sgdma_reset_reset_bridge_in_reset_reset),    // in_rst_0.reset
		.in_0_data      (fifo_memory_out_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (fifo_memory_out_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (fifo_memory_out_agent_rdata_fifo_src_ready), //         .ready
